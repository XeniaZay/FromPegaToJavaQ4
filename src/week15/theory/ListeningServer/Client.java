...
public class Client {
   ...
   // private static BufferedReader in; // поток чтения из сокет
    ...
    public Client(Socket socket) throws IOException {
        ...
        ReadMsg msgReader = new ReadMsg(in);
        msgReader.start();
        WriteMsg msgWriter = new WriteMsg(out,reader);
        msgWriter.start(); // вызываем run()
    }
